...
use syg::{model::Database, stopwatch::start_watch, GlobalIdent};
...
fn main() {
	...
	let v3 = db.decls.find(&GlobalIdent::from_qualified_name("nalgebra::base::alias::Vector3")).unwrap().get_value();
}
